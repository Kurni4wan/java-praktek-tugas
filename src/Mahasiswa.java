...
public class Mahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableMhs.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableMhsMouseClicked(evt);
            }
        });
    ...
    private void jTableMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMhsMouseClicked
        // TODO add your handling code here:
        int row = jTableMhs.getSelectedRow();
        jTFnim.setText(jTableMhs.getValueAt(row, 0).toString());
        jTFnama.setText(jTableMhs.getValueAt(row, 1).toString());
        jTFprodi.setText(jTableMhs.getValueAt(row, 2).toString());
        jTFipk.setText(jTableMhs.getValueAt(row, 3).toString());
    }//GEN-LAST:event_jTableMhsMouseClicked
